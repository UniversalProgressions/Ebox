...
describe("Settings Module", () => {
  ...
  describe("Schema Validation", () => {
    test("should validate correct settings", () => {
      ...
      expect(result).toHaveProperty("http_proxy", "http://proxy.example.com:8080");
  ...
  describe("SettingsService", () => {
    ...
    test("should update and retrieve settings", () => {
      ...
      expect(updated).toHaveProperty("gopeed_api_host", "http://localhost:8080");
    ...
    test("should get config path", () => {
      ...
      expect(configPath).toContain("civitai-manager");
    });
  });
