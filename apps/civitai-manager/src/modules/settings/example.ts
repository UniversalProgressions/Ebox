import { settingsService, type Settings } from "./index";
...
function demonstrateSettingsUsage() {
  ...
  console.log(`   - CivitAI token: ${savedSettings.civitai_api_token.substring(0, 10)}...`);
  ...
  console.log(`   - CivitAI token (unchanged): ${updatedSettings.civitai_api_token.substring(0, 10)}...\n`);
  ...
  try {
    ...
    console.log(`   ✓ Correctly rejected extra field: ${(error as Error).message}\n`);
  }
